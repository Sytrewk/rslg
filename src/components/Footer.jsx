...
const Footer = () => (
<footer className="text-xs text-gray-500 container mx-auto mt-6">
    <p>This website is not an official tool for the game Elite: Dangerous and is not affiliated with Frontier Developments.
    ...
    Wikipedia text is available under the Creative Commons Attribution/Share-Alike License; additional terms may apply. Wikipedia image: Wikipedia / CC-BY-SA-3.0</p>
</footer>
);
